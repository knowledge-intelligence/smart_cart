...
echo "$HOME/colcon_ws/src/STELLA_RASPBERRYPI_ROS2/stella_bringup/stella.rules"
sudo cp $HOME/stella/STELLA_N2_PI_X4_ROS2_v2.0/stella_bringup/stella.rules  /etc/udev/rules.d
echo " "
